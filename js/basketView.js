    ...
    render() {
        ...
        <div class="wrapper-panel">
          ...
          <div class="buttons-save-and-delete-fruits">
            <button id="btnAddFruit" class="btnAdd btnSave btn btn-outline-success btn-lg">save</button>
            <button id="clearFruits" class="btn-delete-all-fruits btn btn-outline-info btn-lg">clear</button>
          </div>
        </div>      
